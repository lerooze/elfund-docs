...
*  Απευθείας από εξουσιοδοτημένους υπαλλήλους της ΤτΕ με βάση τη δομή δεδομένων DBDat
*  Από τις ΜΠΣ των ΕΟ με βάση τη δομή δεδομένων IFDat
*  Από τις ΜΠΣ των ΕΟ με βάση διαφορετική από το IFDAT δομή δεδομένων 
*  Από τη CSDB με βάση τα CSDB_EXTRACTION_FILES
*  Από το RESTful API του RIAD
...
RIAD που αντλούνται από το RIAD_API σε στοιχεία Dat.

Στο κεφάλαιο :doc:`csdb` περιγράφεται ο τρόπος μετατροπής επιλεγμένων στοιχείων
από τα CSDB_EXTRACTION_FILES σε στοιχεία Dat.
