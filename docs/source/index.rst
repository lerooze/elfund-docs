...
Τα εισερχόμενα στοιχεία (IFDat, RIAD, CSDB κτλ) αν ικανοποιούν βασικούς ελέγχους μετατρέπονται σε στοιχεία δομής δεδομένων **DBDAT** και εισάγονται στους πίνακες της **Backend Database**.  Τα στοιχεία επικύρωσης και ελέγχου των εισερχόμενων αρχείων εισάγονται στους πίνακες της βάσης **Validation Database**.  Μετά την φόρτωση τους τα στοιχεία των παραπάνω βάσεων θα αντλούνται μέσω API που πληρεί προδιαγραφές OpenAPI.  
