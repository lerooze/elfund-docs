...
Ο χώρος στον οποίο θα αποθηκεύονται τα εισερχόμενα αρχεία θα πρέπει να είναι προσβάσιμος σε εγκεκριμένους χρήστες της ΔΣ αφού:

* Η ΔΣ είναι ο ιδιοκτήτης των υποβαλλόμενων αρχείων.
* Γίνεται χρήση των αρχείων από τη ΔΣ για σκοπούς επικοινωνίας με τις ΜΠΣ για τη διερεύνηση λαθών
* Γίνεται χρήση των αρχείων για τον έλεγχο της υλοποίησης της πλατφόρμας
...
Οι έλεγχοι στα εισερχόμενα αρχεία περιγράφονται στο κεφάλαιο :doc:`Έλεγχοι ΑΠΑ <apa_checks>`.
